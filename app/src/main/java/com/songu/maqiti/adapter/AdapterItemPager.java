...
public class AdapterItemPager extends PagerAdapter {
		private ArrayList<ImageView> imgList;
		public Context mCon;
		public ItemModel mItem;

		public AdapterItemPager(Context mContext, ItemModel itemModel) {
			this.mCon = mContext;
			...
			else
			{
				...
				m_iv1.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						Intent m = new Intent(mCon, ImageSlideActivity.class);
						mCon.startActivity(m);
					}
				});
				imgList.add(m_iv1);
